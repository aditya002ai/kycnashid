...
//import com.liveness.SetThresholdDialogFragment
//import com.liveness.SetThresholdDialogFragment
//import com.mv.livebodyexample.databinding.LivenessActivityMainBinding
...
class LivenessMainActivity : AppCompatActivity(), SetThresholdDialogFragment.ThresholdDialogListener {
    ...
    private fun init() {
        binding = DataBindingUtil.setContentView(this, R.layout.liveness_activity_main)
...
//                }
    ...
    private fun takeimage(camera: Camera?) {
        try {
            if (camera != null) {
                camera.takePicture(null, null, null, Camera.PictureCallback(){ bytes: ByteArray, camera: Camera ->
                    Utility.getInstance().liveImage = bytes;
                    camera?.release()
                    finish()
//                    startActivity(Intent(this, com.LivenessActivity::class.java))
    ...
    companion object {
        ...
        const val defaultThreshold = 0.985F
